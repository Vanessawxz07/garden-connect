<img width="1430" height="637" alt="局部截取_20260304_175200" src="https://github.com/user-attachments/assets/932bf8bf-6462-494f-9f3f-ad027cbbb784" /># 新游拓展专项 PRD
...
| **Community ▼** | 新增一级入口，下拉菜单含：Discord（由Contributors页面改造）、YouTube、Twitter/X、Contact |
| **Help ▼** | 新增一级入口，下拉菜单含：Beginner's Guide、Safe Trading Guide、Updatelog、FAQ、Feedback |
...
- [ ] **Giveaways 是否在公共导航栏展示？** 倾向不放（因为 Giveaways 始终有游戏上下文，默认 GAG tab，不存在无游戏选择的空状态），仅在游戏导航栏中展示
- [ ] **游戏导航栏是否增加一个游戏首页入口？** 功能菜单前面再加一个入口
...
- 游戏页面：在游戏路径下，明确分属不同游戏，以及特例处理（Giveaway详情页也属此类）--直接使用游戏导航栏（逻辑不变）
