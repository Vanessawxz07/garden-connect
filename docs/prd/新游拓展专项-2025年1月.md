...
| 原文案 | 新文案 | 变更原因 |
|--------|--------|----------|
| Use the official **Grow a Garden trading system** | Always use the official **in-game trading system** | 去除游戏名称，适用所有游戏 |
| check the latest **Grow a Garden Pet Value List** | using our real-time **Item Value List** for your game | 通用化，适用所有游戏的道具价值列表 |
| Special traits like **weight, mutations** can increase worth | **Rare traits and limited editions** often carry extra value | GAG的weight/mutations是游戏特有概念，改为通用表达 |
| Prices for new items peak soon after release | New items often peak in value shortly after release | 微调措辞 |
| Activity is higher during holidays and events | Activity is higher during holidays and **game events** | 增加"game"强调游戏内活动 |
