...
3、**末位"Coming Soon"兜底卡片**

当游戏卡片无法填满整行时，在末位空位展示一张"More games coming soon!"占位卡片，避免行尾留白。
...
| 游戏选项 | 各游戏图标 + 名称 + 各自未读数 |
| 默认选中 | "All Message"；从游戏页进入聊天时自动选中对应游戏 |
| 空状态 | 按选中的筛选值展示对应游戏的空状态和CTA |

<img width="555" height="446" alt="局部截取_20260305_112411" src="https://github.com/user-attachments/assets/4e162e4f-cfd5-4a7a-af00-b80b7f148980" />
