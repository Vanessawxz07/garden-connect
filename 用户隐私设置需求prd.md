...
| 角色 | 说明 | 权限范围 |
|------|------|----------|
| **VIP** | 特权用户（团队成员、KOL、游戏开发者等） | 享有平台特权功能，如创建抽奖、发布动态等 |
| **普通用户（User）** | 默认角色 | 基础功能使用权限 |
...
| 标签 | 英文名称 | 颜色 | 说明 |
|------|----------|------|------|
| 平台官方 | **Official** | 金色（#FFD700） | 平台创始团队成员 |
| 内容创作者 | **Influencer** | 紫色（#9B59B6） | KOL、社区活跃内容创作者 |
| 游戏开发者 | **Game Developer** | 绿色（#27AE60） | Roblox小游戏开发者 |
| 资深用户 | **Veteran** | 蓝色（#3498DB） | 长期活跃的老用户（机制化标签） |
| 信誉交易者 | **Trusted Trader** | 青色（#1ABC9C） | 交易信誉良好的用户（机制化标签） |
