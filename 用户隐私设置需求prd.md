...
| 身份标签 | 英文名称 | 颜色 | 说明 | 交互 |
|------|----------|------|------|
| 平台官方 | **Official** | 紫色 | 平台创始团队成员 |点击后跳转about us页面 |
| 内容创作者 | **Influencer** | 金色 | KOL、社区活跃内容创作者 |点击后跳转到contributor页 |
| 游戏开发者 | **Game Developer** | 绿色  | Roblox小游戏开发者 |点击后跳转用户主页 |
| 资深用户 | **Veteran** | 蓝色 | 长期活跃的老用户（机制化标签）|无交互 |
| 信誉交易者 | **Trusted Trader** | 桔色 | 交易信誉良好的用户（机制化标签）|无交互 |
