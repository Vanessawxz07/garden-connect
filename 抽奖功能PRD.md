...
| [All] [GAG] [BF] [...]  ← 游戏筛选Tab                       |
+-------------------------------------------------------------+
| [Ongoing] [Upcoming] [Ended]  ← 状态筛选Tab（原有）          |
+-------------------------------------------------------------+
| [GiveawayCard with Game Badge]...                           |
+-------------------------------------------------------------+
```
...
- 默认展示"All"（所有游戏）
- 点击游戏Tab筛选对应游戏的抽奖
- URL参数同步：`/giveaways?game=bf&status=ongoing`
- Tab顺序：All > 按配置顺序展示已上线游戏
